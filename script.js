...
(function () {
    ...
    function initDragAndDrop() {
        ...
        itemCards.forEach((card) => {
            card.addEventListener('dragstart', (e) => {
                draggedItemId = parseInt(card.dataset.id);
            ...
            card.addEventListener('dragover', (e) => {
                ...
                const currentId = parseInt(card.dataset.id);
            ...
            card.addEventListener('drop', (e) => {
                ...
                const dropItemId = parseInt(card.dataset.id);
                ...
                if (draggedItemId && draggedItemId !== dropItemId) {
                    ...
                    if (draggedIndex !== -1 && dropIndex !== -1) {
                        ...
                        console.log('Items reordered:', items.map(i => i.id));
    ...
    function loadLibrary() {
        ...
        container.innerHTML = library.map(offer => `
    ...
    function duplicateOffer(id) {
        ...
        // Generate a new unique offer number based on current timestamp + original client
        const now = new Date();
